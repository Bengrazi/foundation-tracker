        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="rounded-full border border-slate-700 bg-slate-900 px-3 py-1 text-[11px]"
            >
      ...
      {newOpen && (
        <section className="space-y-2 rounded-2xl bg-slate-900/80 p-3 ring-1 ring-slate-800">
          ...
          <textarea
            ...
            placeholder="Goal title… (keep it short and sharp)"
          />
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-slate-400">
              This is your <strong>estimated finishing date</strong>.
            </p>
          </div>
          <button
            onClick={addGoal}
            ...
            <div key={h.value} className="space-y-2">
              ...
              <div className="space-y-2">
                {list.map((g, idx) => (
                  <div
                    key={g.id}
                    className="rounded-2xl bg-slate-900/80 p-3 ring-1 ring-slate-800"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex-1 space-y-1">
                        <textarea
                          ...
                          rows={2}
                          className="w-full whitespace-pre-wrap break-words overflow-hidden resize-none border-none bg-transparent text-sm text-slate-100 outline-none"
                        />
                        <div className="flex flex-wrap items-center gap-2 text-[11px] text-slate-400">
                          ...
                          <select
                            value={g.status}
                            onChange={(e) =>
                              updateGoal(g.id, { status: e.target.value as GoalStatus })
                            }
